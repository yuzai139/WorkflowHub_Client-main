...
class Demo {
  constructor(e) {
    (this.element = e),
      (this.shuffle = new Shuffle(e, { itemSelector: ".picture-item" })),
  ...
  addFilterButtons() {
    var e = document.querySelector(".filter-options");
    if (e) {
      const t = Array.from(e.children),
        i = this._handleFilterClick.bind(this);
      t.forEach((e) => {
  ...
  _removeActiveClassFromChildren(e) {
    const t = e["children"];
    for (let e = t.length - 1; 0 <= e; e--) t[e].classList.remove("active");
  }
}
